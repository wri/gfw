...
var Deforestation = function() {
  ...
  function canvas_setup(canvas, coord, zoom) {
    ...
    switch (this.name) {
      case 'loss_75' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_75/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss_50' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_50/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss_30' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_30/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss_25' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_25/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss_20' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_20/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss_15' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_15/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss_10' :
      case 'loss' :
