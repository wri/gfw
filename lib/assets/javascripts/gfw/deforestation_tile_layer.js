...
var Deforestation = function() {
  ...
  function canvas_setup(canvas, coord, zoom) {
    ...
    config.BASELAYER = 'loss'; //hardcoded to make it work until we have other data layers
    switch (config.BASELAYER) {
      case 'loss75' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_75/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss50' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_50/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss30' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_30/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss25' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_25/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss20' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_20/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss15' : var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year_15/' + z + '/' + x + '/' + y + '.png';
      break;
      case 'loss10' :
      case 'loss' :
      default:         var url = 'http://earthengine.google.org/static/hansen_2013/gfw_loss_year/' + z + '/' + x + '/' + y + '.png';
    }
