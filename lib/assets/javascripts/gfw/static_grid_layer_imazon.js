...
var StaticGridLayerImazon = cdb.core.View.extend({
  ...
  _onDateUpdate: function() {
    var query = "SELECT * FROM " + this.options.table + " WHERE date between '" + this.model.get("start_year") + "-" + this.model.get("start_month") + "-1' AND '" + this.model.get("end_year") + "-" + this.model.get("end_month") + "-1'";
