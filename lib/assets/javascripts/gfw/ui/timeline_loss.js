...
gfw.ui.view.TimelineLoss = gfw.ui.view.Widget.extend({
  ...
  updateCoordinates: function(center) {
    this.$coordinates.html('Lat/Long: '+center.lat() + ',' + center.lng());
  },
  ...
  updateMap: function() {
    this.trigger('change_date', this.range_year[0], this.range_year[1]);
  },
  ...
  _onMouseLeaveHandle: function() {
    this.$current_drag.find('.tipsy').delay(1000).fadeOut(150);
  },
