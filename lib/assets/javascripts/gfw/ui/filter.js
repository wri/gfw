var Filter = (function() {
  ...
  function _addForestLossFilter(id, slug, category, name, options) {
    ...
    if (slug === 'loss' && config.BASELAYER === 'loss' || slug === 'forestgain' && _.include(config.MAPOPTIONS.layers, 596)) {
  ...
  function _addForestLossFilters(id, slug, category, name, options) {
    ...
    if (config.BASELAYER === 'loss' || _.include(config.MAPOPTIONS.layers, 596)) {
