...
gfw.ui.view.Wall = gfw.ui.view.Widget.extend({
  ...
  _setMode: function(mode) {
    ...
    if (mode == "login") {
      ...
      this.model.set({ title: "Request an invite", help: "Please enter your email address to request access to the site", button_title: "Send", placeholder: "Enter your email", mode: mode })
    } else if (mode == "thanks") {
