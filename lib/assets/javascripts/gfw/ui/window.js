...
gfw.ui.view.SourceWindow = gfw.ui.view.Widget.extend({
  ...
  show: function(data_slug, source_coverage) {
    ...
    this.$content.find(".source_coverage").hide();
    this.$content.find(".source_header").show();
    this.$content.find(".source_coverage_header").hide();
    ...
    if (source_coverage) {
      ...
      this.$content.find("article, ul, ul li, .source_body, .source_header").hide();
      this.$content.find("ul li").removeClass("expanded");

      this.$content.find(".source_coverage_header").show();
      this.$content.find("[data-slug=" + data_slug_ + "]").show();
      this.$content.find("[data-slug=" + data_slug_ + "]").addClass("expanded");

      this.$content.find(".source_coverage").show();
      ...
      this.$content.find("ul li ul, ul li ul li, .source_body").show();
      this.$content.find("ul li").removeClass("expanded");
