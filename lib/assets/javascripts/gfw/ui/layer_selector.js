...
gfw.ui.view.LayerSelector = gfw.ui.view.Widget.extend({
  ...
  initialize: function() {
    ...
    this.layers.add(new gfw.ui.model.Layer({ style: config.BASE_MAP_STYLE, customMapType: "TERRAIN", title: "Grayscale", name: "terrain", selected: true }));
    ...
    this.layers.add(new gfw.ui.model.Layer({ mapType: google.maps.MapTypeId.HYBRID, title: "Roads", name: "roads", }));
  ...
  onLayerClick: function(e) {
    ...
    ga('send', 'event', 'LayerSelector', 'Change', layer.get('title'));
