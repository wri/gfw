gfw.ui.model.TimelineImazon = Backbone.Model.extend({
  defaults: {
    hidden: true
  }
});
...
gfw.ui.view.TimelineImazon = gfw.ui.view.Widget.extend({
  ...
  initialize: function() {
    ...
    this.first_month   = 0; // Numeric value of the first month of the timeline (January 2006)
  ...
  */
  ...
  _updateMap: function(side, value) {
    ...
    if (this.months[start_pos] && this.months[end_pos]) {
      ...
      // console.log((start_month%12)+1, start_year, " - ", (end_month%12)+1, end_year);

      this.trigger('change_date', (start_month%12)+1, (end_month%12)+1, start_year, end_year);
    }
