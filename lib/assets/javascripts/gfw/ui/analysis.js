...
gfw.ui.view.DownloadDropdown = gfw.core.View.extend({
  ...
  _generateURL: function(format) {
    ...
    if (dataset === 'hansen') {
      return 'http://hansen.gfw-apis.appspot.com/datasets/' + dataset + '?layer=loss&geom=' + encodeURI(area); // loss
    } else {
      return '//wip.gfw-apis.appspot.com/datasets/' + dataset + '.' + format + '?begin=2006-01-01&end=' + endDate + '&geom=' + encodeURI(area);
    }
