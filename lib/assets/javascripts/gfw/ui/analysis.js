...
gfw.ui.view.DownloadDropdown = cdb.core.View.extend({
  ...
  _generateURL: function(format) {
    ...
    if (dataset === 'protected') {
      ...
      return 'http://wip.gfw-apis.appspot.com/datasets/hansen?layer=sum&geom=' + area;
    } else {
      return '//wip.gfw-apis.appspot.com/datasets/' + dataset + '.' + format + '?begin=' + beginAt + '&end=' + endAt + '&' + area;
    }
