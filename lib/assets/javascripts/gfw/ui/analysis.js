...
gfw.ui.view.AnalysisInfo = gfw.ui.view.Widget.extend({
  ...
  initialize: function() {
    _.bindAll( this, "toggleDraggable", "onStopDragging", "_onClickSubscribe", "_toggleOpen", "open", "close");
    ...
    subscribe('timeline:change_date', _.bind(function(y0, m0, y1, m1) {
      ...
      this.model.set({'alert_count': 'Updating dates... '});
...
gfw.ui.view.Analysis = gfw.core.View.extend({
  ...
  **/
  ...
  render: function() {
    ...
    // // Get FORMA alert count:

    //   var start = '2005-03-05';
    //   var end = '2006-08-01';

    //   executeAjax(
    //     'http://gfw-apis.appspot.com/api/v1/defor/analyze/forma/iso/bra/2005-03-05/2006-08-01', 
    //     {}, 
    //     {
    //       success: _.bind(function(data) {
    //         console.log(data);
    //         this.info.model.set({'alert_count': data.value_display});
    //       }, this), 
    //       error: _.bind(function(error) {
    //         console.log(error);
    //       }, this)
