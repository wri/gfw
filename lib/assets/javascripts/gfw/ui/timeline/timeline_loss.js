...
gfw.ui.view.TimelineLoss = gfw.ui.view.Widget.extend({
  ...
  _init: function() {
    ...
    url_begin = (url('?begin') <= 2000) ? 2001 : url('?begin');
    url_end   = (url('?end') > today.getUTCFullYear() - 1) ? today.getUTCFullYear() - 1 : url('?end');

    url_begin = url_begin.toString();
    url_end   = url_end.toString();
