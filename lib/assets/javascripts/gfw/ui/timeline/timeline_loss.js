...
gfw.ui.view.TimelineLoss = gfw.ui.view.Widget.extend({
  ...
  show: function() {
    ...
    if (!!this.$coordinates && this.$coordinates.hasClass('visibility_show')) this.$coordinates.removeClass('visibility_show');
  },
  ...
  hide: function(_show_gain) {
    if (_show_gain) {
      ...
      this.$coordinates.addClass('visibility_show');
    } else {
