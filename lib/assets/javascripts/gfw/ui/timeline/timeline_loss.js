...
gfw.ui.view.TimelineLoss = gfw.ui.view.Widget.extend({
  ...
  initialize: function() {
    _.bindAll(this, '_onStartDrag', '_toggle', '_onDrag', '_onStopDragging', '_animate', '_stopAnimation');
  ...
  updateMap: function(publish) {
    this.trigger('change_date', this.range_year[0], this.range_year[1], publish);
  },
