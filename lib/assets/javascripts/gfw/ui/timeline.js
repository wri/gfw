...
gfw.ui.view.Timeline = cdb.core.View.extend({
  ...
  _toggleBaselayer: function() {
    ...
    if (baselayer === 'loss') {
      ...
      //the next is boolean true if we DON'T have any baselayer defined: gain layer or none layer case (baselayer is null, 'falsey').
      that.loss_timeline.hide( (! !!baselayer) );
    }
