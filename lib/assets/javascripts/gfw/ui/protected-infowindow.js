...
ProtectedInfowindow.prototype.draw = function() {
  ...
  if (!div) {
    ...
    div.innerHTML = '<a href="#close" class="close"></a>'+
      ...
      '<h1></h1><a href="#" class="analyse disabled"></a><div class="cover imgLiquidFill" style="width:295px; height:120px;"><img src="/assets/backgrounds/cover.png" /></div>'+
      '</div>' +
      '<div class="top">'+
...
ProtectedInfowindow.prototype.setContent = function(content, baselayer){
