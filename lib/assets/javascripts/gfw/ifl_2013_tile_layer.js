function Ifl_2013TileLayer(canvas_setup, filter) {
  this.tileSize = new google.maps.Size(256, 256);
  this.maxZoom = 19;
  this.name = "ifl_2013";
  this.alt = "Canvas ifl_2013 tile layer";
  this.tiles = {};
...
Ifl_2013TileLayer.prototype.create_tile_canvas = function(coord, zoom, ownerDocument) {
...
Ifl_2013TileLayer.prototype.filter_tile = function(canvas) {
  var ctx = canvas.getContext('2d');
...
Ifl_2013TileLayer.prototype.composed = function(map, w, h) {
...
Ifl_2013TileLayer.prototype.filter_tiles = function() {
  var args = Array.prototype.slice.call(arguments);
  for(var c in this.tiles) {
    this.filter_tile(this.tiles[c], args);
  }
}
Ifl_2013TileLayer.prototype.getTile = function(coord, zoom, ownerDocument) {
  // could be called directly...
  return this.create_tile_canvas(coord, zoom, ownerDocument);
};

Ifl_2013TileLayer.prototype.releaseTile = function(tile) {
  var id = tile.getAttribute('id');
  delete this.tiles[id];
};

// optimized version for threshold rendering
function Ifl_2013TileLayerThreshold (canvas_setup, filter) {
  Ifl_2013TileLayer.call(this, canvas_setup, filter);
  this.threshold = 0;
  this.start_threshold = 0;
}


Ifl_2013TileLayerThreshold.prototype = new Ifl_2013TileLayer();

Ifl_2013TileLayerThreshold.prototype.filter_tiles = function() {
  var new_threshold = arguments[0];
  Ifl_2013TileLayer.prototype.filter_tiles.apply(this, arguments)
  this.threshold = new_threshold;
}

Ifl_2013TileLayerThreshold.prototype.filter_tile = function(canvas) {
  var ctx = canvas.getContext('2d');
...
var Ifl_2013 = function() {
  ...
  function canvas_setup(canvas, coord, zoom) {
    ...
    var url = 'https://wri-01.cartodb.com/tiles/ifl_2013/%z/%x/%y.png';
    ...
    xhr.onload = function () {
      ...
      image.onload = function () {
        ...
        Ifl_2013.heightLayer.filter_tile(canvas);
  ...
  me.init = function(map, callback) {
    this.map = map;
    this.heightLayer = new Ifl_2013TileLayerThreshold(canvas_setup, filter);
  ...
  me.hide = function() {
    ...
    if (overlays_length > 0) {
      for (var i = 0; i< overlays_length; i++) {
        ...
        if (layer && layer.name == 'ifl_2013') this.map.overlayMapTypes.removeAt(i);
      }
    }
  }
