...
const getData = (state) => state?.recentImagery?.data;
export const getRecentImageryLoading = (state) => state.recentImagery?.loading;
export const getLoadingMoreTiles = (state) =>
  state.recentImagery?.loadingMoreTiles;
const getError = (state) => state.recentImagery?.error;
const getLocation = (state) => state.location?.query;
const getDataStatus = (state) => state.recentImagery?.dataStatus;
