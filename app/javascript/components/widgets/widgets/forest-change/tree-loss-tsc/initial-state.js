export default {
  ...
  config: {
    ...
    sentences: {
      ...
      perm:
        '(permenant deforestation) is the dominant driver of land cover/land use change.',
      temp:
        '(temporary deforestation) is the dominant driver of land cover/land use change.'
    }
  },
  settings: {
    threshold: 0,
