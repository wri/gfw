        ...
        <div className="c-widget-stories__container">
          <div className="row">
            <div className="columns c-widget-stories__primary-info">
              ...
              <p className="description">Thousands of people around the world use GFW every day to monitor and manage forests, stop illegal deforestation and fires, call out unsustainable activities, defend their land and resources, sustainably source commodities, and conduct research at the forefront of conservation.</p>
              <a className="link" href="">See more on the map</a>
            </div>
            <div className="columns c-widget-stories__secondary-info">
              <div className="circle"></div>
              <h3>Stories</h3>
              <p className="title-name">Claire Salisbury</p>
              <p className="description">Keeping Amazon Fish connected is key to their conservation</p>
              <a className="link" href="">See more on the map</a>
            </div>
          </div>
        </div>
