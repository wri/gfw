  ...
  render() {
    ...
    return count > paginate.limit ?
      <div className="c-widget-paginate">
        {showPrevious && <div className="c-widget-paginate__icon c-widget-paginate__icon--up" onClick={() => onClickPreviousPage()}>
          <svg className="icon icon-angle-arrow-down"><use xlinkHref="#icon-angle-arrow-down"></use></svg>
        </div>}
        {showNext && <div className="c-widget-paginate__icon" onClick={() => onClickNextPage()}>
          <svg className="icon icon-angle-arrow-down"><use xlinkHref="#icon-angle-arrow-down"></use></svg>
        </div>}
      </div>
      : null;
