// intro
import intro1x from 'layouts/topics/assets/climate/intro/leaf.png?webp';
import intro2x from 'layouts/topics/assets/climate/intro/leaf@2x.png?webp';

// slides
import climate1 from 'layouts/topics/assets/climate/slides/climate1.png?webp';
import climate1Large from 'layouts/topics/assets/climate/slides/climate1@2x.png?webp';
import climate2 from 'layouts/topics/assets/climate/slides/climate2.png?webp';
import climate2Large from 'layouts/topics/assets/climate/slides/climate2@2x.png?webp';
import climate3 from 'layouts/topics/assets/climate/slides/climate3.png?webp';
import climate3Large from 'layouts/topics/assets/climate/slides/climate3@2x.png?webp';
import climate4 from 'layouts/topics/assets/climate/slides/climate4.png?webp';
import climate4Large from 'layouts/topics/assets/climate/slides/climate4@2x.png?webp';

// cards
import monitor from 'layouts/topics/assets/climate/cards/monitor.png?webp';
import monitorLarge from 'layouts/topics/assets/climate/cards/monitor@2x.png?webp';
import explore from 'layouts/topics/assets/climate/cards/explore.png?webp';
import exploreLarge from 'layouts/topics/assets/climate/cards/explore@2x.png?webp';
import carbon from 'layouts/topics/assets/climate/cards/carbon.png?webp';
import carbonLarge from 'layouts/topics/assets/climate/cards/carbon@2x.png?webp';
import insights from 'layouts/topics/assets/climate/cards/insights.png?webp';
import insightsLarge from 'layouts/topics/assets/climate/cards/insights@2x.png?webp';
import research from 'layouts/topics/assets/climate/cards/research.png?webp';
import researchLarge from 'layouts/topics/assets/climate/cards/research@2x.png?webp';
  ...
  slides: [
    {
      ...
      prompts: [
        ...
        },
        {
          ...
          link:
            `${window.location.origin}/map?map=&menu=eyJtZW51U2VjdGlvbiI6IiIsImRhdGFzZXRDYXRlZ29yeSI6IiJ9`,
          position: [65, 55]
        }
      ],
      animations: [
      ...
      prompts: [
        {
          ...
          btnText: 'Explore the data',
          link:
            `${window.location.origin}/map?map=%3D&menu=eyJtZW51U2VjdGlvbiI6IiIsImRhdGFzZXRDYXRlZ29yeSI6IiJ9`,
          position: [65, 50]
        }
      ],
      animations: [
