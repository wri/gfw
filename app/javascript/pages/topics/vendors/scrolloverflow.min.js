...
!(function(t, i, s) {
  let e =
    ...
    o = (function() {
      let e = {},
        ...
        n = (function() {
          for (
            let t = ['t', 'webkitT', 'MozT', 'msT', 'OT'], i = 0, s = t.length;
            i < s;
            i++
          ) {
          ...
          return (
            ...
            (h = t + c * c / (2 * r) * (l < 0 ? -1 : 1)) < o
              ? ((h = n ? o - n / 2.5 * (c / 8) : o),
                (a = (l = s.abs(h - t)) / c))
              : h > 0 &&
                ((h = n ? n / 2.5 * (c / 8) : 0), (a = (l = s.abs(t) + h) / c)),
      ...
      return (
        ...
        (e.isBadAndroid = (function() {
          const i = t.navigator.appVersion;
          if (/Android/.test(i) && !/Chrome\/\d/.test(i)) {
            const s = i.match(/Safari\/(\d+.\d)/);
            return (
              !(s && typeof s === 'object' && s.length >= 2) ||
        ...
        (e.preventDefaultException = function(t, i) {
          for (const s in i) if (i[s].test(t[s])) return !0;
          return !1;
        }),
  ...
  function n(s, e) {
    for (const n in ((this.wrapper =
      typeof s === 'string' ? i.querySelector(s) : s),
  ...
  function h(s, n) {
    for (const r in ((this.wrapper =
      typeof n.el === 'string' ? i.querySelector(n.el) : n.el),
    ...
    if (
      ...
      const h = o.style.transitionDuration;
      if (!h) return;
      this.wrapperStyle[h] = o.isBadAndroid ? '0.0001ms' : '0ms';
      const a = this;
      o.isBadAndroid &&
        e(() => {
          a.wrapperStyle[h] === '0.0001ms' && (a.wrapperStyle[h] = '0s');
        }),
  ...
  (n.prototype = {
    ...
    _start(t) {
      if (
        o.eventType[t.type] != 1 &&
        (t.which ? t.button : t.button < 2 ? 0 : t.button == 4 ? 1 : 2) !== 0
      ) {
        return;
      }
      if (
          ...
          (a = this.hasHorizontalScroll ? a : 0),
            ...
            (i > 0 || i < this.maxScrollX) &&
              (i = this.options.bounce
                ? this.x + a / 3
                : i > 0 ? 0 : this.maxScrollX),
            (e > 0 || e < this.maxScrollY) &&
              (e = this.options.bounce
                ? this.y + l / 3
                : e > 0 ? 0 : this.maxScrollY),
    ...
    off(t, i) {
      if (this._events[t]) {
        const s = this._events[t].indexOf(i);
    ...
    scrollTo(t, i, s, e) {
      ...
      const n = this.options.useTransition && e.style;
      !s || n
        ? (n &&
      ...
      if ((t = t.nodeType ? t : this.scroller.querySelector(t))) {
        ...
        (h.left -= this.wrapperOffset.left),
          ...
          (h.left =
            h.left > 0
              ? 0
              : h.left < this.maxScrollX ? this.maxScrollX : h.left),
          (h.top =
    ...
    _transitionTime(t) {
      if (this.options.useTransition) {
        t = t || 0;
        const i = o.style.transitionDuration;
        if (i) {
          if (((this.scrollerStyle[i] = `${t}ms`), !t && o.isBadAndroid)) {
            this.scrollerStyle[i] = '0.0001ms';
            const s = this;
            e(() => {
              s.scrollerStyle[i] === '0.0001ms' && (s.scrollerStyle[i] = '0s');
            });
          }
          if (this.indicators) {
            for (let n = this.indicators.length; n--; ) {
    ...
    _translate(t, i) {
      if (
        (this.options.useTransform
          ? (this.scrollerStyle[o.style.transform] = `translate(${t}px,${i}px)${
              this.translateZ
            }`)
          : ((t = s.round(t)),
            (i = s.round(i)),
        ...
        for (let e = this.indicators.length; e--; ) {
          this.indicators[e].updatePosition();
        }
      }
    },
    _initEvents(i) {
      let s = i ? o.removeEvent : o.addEvent,
    ...
    _initIndicators() {
      let t,
        ...
        s = typeof this.options.scrollbars !== 'string',
        e = [],
        o = this;
      (this.indicators = []),
      ...
      for (let n = e.length; n--; ) this.indicators.push(new h(this, e[n]));
      function a(t) {
        if (o.indicators) {
          for (let i = o.indicators.length; i--; ) t.call(o.indicators[i]);
        }
      }
          ...
          if (
            ...
            if (!0 === this.options.snap) {
              ...
              for (t = (r = this.options.snap).length, i = -1; h < t; h++) {
                (h === 0 || r[h].offsetLeft <= r[h - 1].offsetLeft) &&
                  ((a = 0), i++),
    ...
    _initKeys(i) {
      ...
      if (typeof this.options.keyBindings === 'object') {
        for (s in this.options.keyBindings) {
          typeof this.options.keyBindings[s] === 'string' &&
    ...
    (h.prototype = {
      ...
      _start(i) {
        const s = i.touches ? i.touches[0] : i;
        i.preventDefault(),
          i.stopPropagation(),
          this.transitionTime(),
          (this.initiated = !0),
      ...
      _end(i) {
        if (this.initiated) {
          if (
            ...
            let e = this.scroller._nearestSnap(
                this.scroller.x,
                this.scroller.y
              ),
              n =
      ...
      transitionTime(t) {
        ...
        if (i && ((this.indicatorStyle[i] = `${t}ms`), !t && o.isBadAndroid)) {
          ...
          const s = this;
          e(() => {
            s.indicatorStyle[i] === '0.0001ms' && (s.indicatorStyle[i] = '0s');
          });
        }
      },
      ...
      updatePosition() {
        ...
        this.options.ignoreBoundaries ||
          ...
          this.scroller.options.useTransform
            ? (this.indicatorStyle[o.style.transform] = `translate(${t}px,${
                i
    ...
    t.fp_scrolloverflow = (function() {
      ...
      function u() {
        ...
        function o(t) {
          if (!fp_utils.hasClass(t, 'fp-noscroll')) {
            ...
            const c = fp_utils.getWindowHeight() - a;
            i > c
              ? h != null
                ? e.update(t, c)
                : (s.options.verticalCentered
      ...
      var f = null,
        m = {
          ...
          toggleWheel(t) {
            f(e, f(r)[0]).forEach(i => {
              const s = i.fp_iscrollInstance;
              s != null && (t ? s.wheelOn() : s.wheelOff());
            });
          },
          onLeave() {
            m.toggleWheel(!1);
          ...
          create(t, i, s) {
            f(e, t).forEach(e => {
              ...
              let o = e.fp_iscrollInstance;
              o != null &&
                m.iScrollInstances.forEach(t => {
                  t.destroy();
                }),
                (o = new IScroll(e, s)),
          ...
          update(t, i) {
            ...
            const s = m.fullpageOptions.verticalCentered ? i + d(t) : i;
