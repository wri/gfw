...
const getMoreTiles = createThunkAction('getMoreTiles', params => (dispatch, state) => {
  getTiles(params)
      ...
      getThumbs(params)
        .then(getThumbsResponse => {
          if (
            ...
            const data = state().recentImagery.data;
            getTilesResponse.data.data.attributes.forEach(item => {
