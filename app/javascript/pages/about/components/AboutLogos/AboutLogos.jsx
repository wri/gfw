        ...
        <div className="c-about-footer-logos">
          ...
          <div className="row">
            ...
            <div className="c-about-footer-logos__subscribe small-12 columns">
              <span className="text -title-xs -color-3">We welcome others to join the growing GFW partnership.</span>
              <ButtonRegular text="EMAIL US" color="green" clickFunction={this.openModal} />
            </div>
          </div>
        </div>
