...
export const initialState = {
  ...
  config: {
    sentences: {
      ...
      countrySpecific: {
        IDN:
          'In 2001, {location} had {primaryLoss} of primary forest, extending over {percentagePrimaryForest} of its land area. In {year}, it lost {loss} of primary forest, equivalent to {emissionsPrimary} of CO₂ of emissions. In 2010 {location_1} had {naturalForest} of natural forest, extending over {percentageNatForest} of its land area. In 2018, it lost {naturalLoss} of natural forest, equivalent to {emissions} of CO₂ of emissions.'
      },
