class CountriesController < ApplicationController
  ...
  def show
    ...
    response = Typhoeus.get("https://wri-01.cartodb.com/api/v2/sql?q=SELECT%20*%20FROM%20mongabaydb%20WHERE%20position('#{@country['name']}'%20in%20keywords)%20%3C%3E%200", headers: { "Accept" => "application/json" })
