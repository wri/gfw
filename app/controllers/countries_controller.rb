...
class CountriesController < ApplicationController
  def show
    ...
    post = OpenStruct.new( {
      ...
      link:  'http://globalforestwatch.tumblr.com/post/25154304598/global-forest-watch-2-0-at-rio-20',
    ...
    post = OpenStruct.new({
      ...
      link: 'http://globalforestwatch.tumblr.com/post/25154024940/new-study-highlights-opportunities-and-challenges-for',
    ...
    post = OpenStruct.new({ 
      ...
      link: 'http://globalforestwatch.tumblr.com/post/25153822817/forest-land-allocation-in-cameroon',
