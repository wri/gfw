  ...
  private
    ...
    def validate_url
      if (params[:basemap].present? && params[:baselayer].present?)
        baselayers = ['loss','loss10','loss15','loss20','loss20','loss25','loss30','loss50','loss75','forma', 'imazon', 'modis', 'fires', 'none']
