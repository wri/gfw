  ...
  */
  ...
  CustomInfowindow.prototype.draw = function() {
    ...
    if (!div) {
      ...
      div.className = this.className || "mod-custom-infowindow";
      ...
      google.maps.event.addDomListener(analyse, 'click', function (ev) {
        ...
        Analysis._loadUseConservationAreas(me.content.geom.the_geom, me.content.id, me.content.name, 'wdpa_all');
  ...
  CustomInfowindow.prototype.setTemplate = function(template){
    this.template_ = template;
  };

  CustomInfowindow.prototype.setOffset = function(offsetVertical, offsetHorizontal){
  ...
  CustomInfowindow.prototype.setPosition = function(latlng) {
    if (latlng) {
      this.latlng_ = latlng;
      // Adjust pan
      this._adjustPan();
  ...
  CustomInfowindow.prototype.close2 = function(){
    this._hide();
  };
  ...
  CustomInfowindow.prototype._hide = function() {
  ...
  CustomInfowindow.prototype._show = function() {
    if (this.div_) {
  ...
  CustomInfowindow.prototype._adjustPan = function() {
    var left = 0
    , top = 0
  ...
  CustomInfowindow.prototype.getElementsByClassName = function(classname, node)  {
