...
define([
  ...
  'map/views/maptypes/urthecastMapType',
  'map/helpers/layersHelper'
], function(Backbone, _, mps, Presenter, grayscaleMaptype, treeheightMaptype, darkMaptype, positronMaptype, landsatMaptype, urthecastMapType, layersHelper) {
  ...
  var MapView = Backbone.View.extend({
    ...
    _setMaptypes: function() {
      ...
      this.map.mapTypes.set('urthe', urthecastMapType());
