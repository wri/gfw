...
define([
  ...
  var UsaConservationEasementsLayer = CartoDBLayerClass.extend({
    ...
    options: {
      sql: 'SELECT the_geom_webmercator, sitename as name, gis_acres, rep_acres, state, purpose, pubaccess, duration, dataagg, datapvdr, esmthldr, eholdtyp, {analysis} AS analysis, \'{tableName}\' as layer FROM {tableName}',
      infowindow: true,
