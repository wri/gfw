...
define([
  ...
  var CanCoalMiningLayer = CartoDBLayerClass.extend({
    ...
    options: {
      sql: 'SELECT \'{tableName}\' as tablename, cartodb_id, the_geom_webmercator, area_eq_ha as area_ha, lease_name as name, \'{tableName}\' AS layer, {analysis} AS analysis FROM {tableName}' ,
      infowindow: true,
