...
define([
  ...
  var LoggingLayer = CartoDBLayerClass.extend({
    ...
    options: {
      sql: 'SELECT \'logging\' as tablename, cartodb_id, the_geom_webmercator, company, country, round(area_ha::float) as area_ha, name, source,status, \'{tableName}\' AS layer, {analysis} AS analysis FROM {tableName}' ,
      infowindow: true,
