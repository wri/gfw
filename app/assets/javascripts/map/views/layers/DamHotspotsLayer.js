...
define([
  ...
  var DamHotspotsLayer = CartoDBLayerClass.extend({
    ...
    options: {
      sql: 'SELECT the_geom_webmercator, basin_name, project as project_na, capacity, rivers, status, campaign,  {analysis} AS analysis, \'{tableName}\' AS layer FROM {tableName}',
      infowindow: true,
      interactivity: ' basin_name, project_na, capacity, rivers, status',
      analysis: false,
