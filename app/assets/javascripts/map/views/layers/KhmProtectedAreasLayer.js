...
define([
  ...
  var KhmProtectedAreasLayer = CartoDBLayerClass.extend({
    ...
    options: {
      sql: "SELECT \'{tableName}\' as tablename, cartodb_id, the_geom_webmercator, name, round(size_ha/10000) as area_ha, type_area as category, to_char(issuedate, 'MM/DD/YYYY') as date_create, \'{tableName}\' AS layer, {analysis} AS analysis FROM {tableName}" ,
      infowindow: true,
