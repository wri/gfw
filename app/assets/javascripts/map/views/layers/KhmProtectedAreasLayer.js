...
define([
  ...
  var KhmProtectedAreasLayer = CartoDBLayerClass.extend({
    ...
    options: {
      sql: "SELECT \'{tableName}\' as tablename, cartodb_id, the_geom_webmercator, name_en as name, round((size_ha::float)/10000) as area_ha, category, to_char(issuedate, 'MM/DD/YYYY') as date_create, \'{tableName}\' AS layer, {analysis} AS analysis FROM {tableName}" ,
      infowindow: true,
