...
define([
  ...
  var MiningLayer = CartoDBLayerClass.extend({
    ...
    options: {
      sql: 'SELECT cartodb_id, \'mining\' as tablename, the_geom_webmercator, status,company, country, area_ha, name, permit as permit_num, mineral as type, province, \'{tableName}\' AS layer, {analysis} AS analysis FROM {tableName} ',
      infowindow: true,
