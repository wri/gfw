define([], function() {
  ...
  var guideTexts = {
    ...
    analysistab:      '<p>Click the <strong>Analysis icon</strong> to <strong>perform an analysis</strong> for a drawn shape, a country or subnational region, or for a polygon in another data layer.</p>',
    subscriptiontab : '<p>The <strong>Subscription icon</strong> allows you to <strong>sign up</strong> to receive an email when there is a <strong>new forest change alert</strong> or user story for an area of interest.</p>',
