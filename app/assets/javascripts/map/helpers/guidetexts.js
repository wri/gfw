define([], function() {
  ...
  var guideTexts = {
    ...
    layersmenu:       '<p>By default, the map displays tree cover gain and loss data. Use the tabs at the top of the map to turn on other global data layers.</p>'+
                      '<p>To learn more about a data set, click on the green information icon in the drop down menu.</p>',
