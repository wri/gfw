define([], function() {
  ...
  config.GRAPHS = {
    total_loss: {
      title: "Countries with greatest tree cover loss (2001-2016)",
      subtitle: "Global tree cover loss, 2001-2016<a href='#' class='info' data-source='total_loss'><i class='dark'></i></a>"
    },
    percent_loss: {
    ...
    total_extent: {
      ...
      subtitle: "Global tree cover, 2000 <a href='#' class='info' data-source='total_loss'><i class='dark'></i></a>"
    },
    ratio: {
