define([], function() {
  ...
  var interestingHelper = {
    ...
    about_fires: {
      ...
      description: 'Learn about GFW Fires, a tool to monitor emerging fires, identify potential causes, and analyze impacts of fires on forests and people.',
      link: 'http://fires.globalforestwatch.org/#v=about&x=115&y=0&l=5&lyrs=Active_Fires',
    },
    about_commodities: {
      title: 'About GFW Commodities',
      description: 'Learn more about the GFW Commodities, a tool to address deforestation in commodity supply chains.',
    ...
    explore_applications: {
      ...
      description: 'Explore GFW apps, tools designed to address specific forest issues.',
