...
define([
  ...
  var WMSLayerClass = OverlayLayerClass.extend({
    ...
    _radiansToDegrees: function(rad) {
    ...
    // MercatorProjection.prototype.fromLatLngToPoint = (latLng, opt_point) {
    //     var me = this;
    ...
    _loadWMS: function(map, baseURL, customParams) {
      ...
      if (!baseURL) {
        baseURL = 'http://downloads.wdpa.org/ArcGIS/rest/services/ocean_data_viewer/mangrove_usgs3/MapServer';
      }
      if (! wmsStandardParams) {
        wmsStandardParams = [
          "REQUEST=GetMap",
          "SERVICE=WMS",
          "VERSION=1.1.1",
      ...
      var overlayOptions = {
          getTileUrl: function(coord, zoom) {
              ...
              var lUL_Latitude = coord.y;
              var lUL_Longitude = coord.x;
