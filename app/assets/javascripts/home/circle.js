var Circle = (function() {
  ...
  function _build(){
    ...
    if ( $("#circle-template").length > 0 ) {
      ...
      $title      = $circle.find(".circle-title");
      $icon       = $circle.find(".icon");
      $counter    = $circle.find(".circle-counter");
      $background = $circle.find(".circle-background");
      $explore    = $circle.find(".circle-explore");
  ...
  function _onMouseEnter() {
    ...
    $circle.find(".circle-title, .circle-counter").stop().animate({ opacity: 0 }, 100, "easeInExpo", function() {
      $circle.find(".circle-explore, .circle-background").stop().animate({ opacity: 1 }, 100, "easeOutExpo");
  ...
  function _onMouseLeave() {
    ...
    $circle.find(".circle-explore, .circle-background").stop().animate({ opacity: 0 }, 100, "easeOutExpo", function(){
  ...
  function _hide(e) {
    ...
    if ($circle) {
      $circle.find(".circle-title, .circle-counter").animate({ opacity: 0 }, 150, "easeOutExpo", _afterHide);
    }
  }
  ...
  function _onClick(e) {
    ...
    window.location = 'http://www.globalforestwatch.org/map';
  }
