...
const testConfig = [
  {
    ...
    tests: [
      {
        ...
        'data-test': 'sentence-treeCoverGainSimple',
        sentence:
      ...
      },
      {
        ...
        'data-test': 'sentence-treeCover2000',
        sentence:
    ...
    spec: {
      test: (test) => {
        ...
        cy.isValidSentence(test['data-test'], test.sentence);
      },
    },
  },
];
