...
feature 'GFW country detail page' do
  ...
  scenario 'shows a list of blog stories' do
    within '#content #country .blog_posts' do
      page.should have_content 'Central African Republic Blog Stories'
      page.should have_css 'ul li', :length => 3
      page.should have_css 'ul li h5', :text => 'Kony Tracked by U.S. Forces in Central Africa', :length => 2
      page.should have_css 'ul li h5', :text => 'U.N. Says Congo Rebels Killed Scores...'
