  ...
  slides: [
    {
      ...
      text: 'In higher-latitude forests, fires help maintain a healthy forest ecosystem by releasing important nutrients into the soil and aiding in seed dispersal. In tropical forests, local and indigenous communities have used controlled fires for centuries to clear land for agriculture.',
      img1x: fires1,
      prompts: [
        {
          id: 'fires-learn',
          ...
          link: 'https://blog.globalforestwatch.org/fires/boreal-forest-fires-a-climate-concern',
          position: [65, 38],
        },
      ],
      animations: [
    ...
    },
    {
      ...
      text: 'Climate change and forest degradation and fragmentation have led to more fire-prone conditions globally. With hotter and drier conditions, fires - either ignited by humans or by lightning - are more likely to burn over larger areas and at hotter temperatures. Forests degraded by logging and disease, and fragmented by deforestation are also more susceptible to fire.',
      img1x: fires2,
      prompts: [
        {
          id: 'fires-learn',
          ...
          link: '/dashboards/global?category=fires&map=%3D%3D',
          position: [80, 60],
        },
      ],
      animations: [
      ...
      prompts: [
        {
          ...
          link: '/map?map=&menu=eyJtZW51U2VjdGlvbiI6IiIsImRhdGFzZXRDYXRlZ29yeSI6IiJ9',
          position: [38, 45],
        },
      ],
      animations: [
    ...
    },
    {
      ...
      text: 'Prescribed burning, improved maintenance of infrastructure, awareness raising and education on fire prevention, and policy interventions such as fire bans can reduce the risk of forest fires. Protecting forests from deforestation and degradation also improve forest resilience to fire.',
      img1x: fires4,
      prompts: [
        {
          id: 'fires-learn',
          ...
          btnText: 'Read the blog',
          link: 'https://blog.globalforestwatch.org/people/women-research-institute-blazes-path-towards-fire-safety-in-riau-communities',
          position: [35, 55],
        },
      ],
      animations: [
