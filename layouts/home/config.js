...
export default {
  summary: [
    ...
    },
    {
      ...
      summary:
        'Check out stories on data and tools, GNW users in the field, and findings from our team of researchers on the GNW blog.',
      buttons: [
        {
          text: 'START LEARNING',
  ...
  uses: [
    ...
    },
    {
      profile: 'Policymaker',
      example:
        'At the Forest Development Authority in Liberia, we saw a need to improve science-based decision making in forest resource management. We developed a Forest Atlas with Global Forest Watch [now Global Nature Watch] that allows us to manage and share information about forest cover and land use. The Forest Atlas revolutionized how we communicate about the forest sector in Liberia.',
      credit: {
    ...
    },
    {
      profile: 'Company',
      example:
        'At Mars, deforestation poses a risk to our business – we don’t want our supply chains to be associated with serious environmental issues. We used the PALM risk tool on Global Forest Watch [now Global Nature Watch] Commodities to evaluate our palm oil suppliers and help us make decisions about where to source from. With Global Forest Watch [now Global Nature Watch], we were able to turn concerns about deforestation into an actionable method for engaging our suppliers.',
      credit: {
        name: 'Marufish',
  ...
  apps: [
    {
      ...
      description:
        "Access GNW's nature monitoring and alert system offline and collect data from the field, all from your mobile device",
