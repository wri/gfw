...
export const sgfBenefits = [
  ...
  'Form part of the GNW partnership.',
];
...
export const fellowshipBenefits = [
  ...
  'All expenses paid (airfare, visa costs, meals and accommodation) to participate in tech camp and the GNW User Summit in Washington, DC.',
  ...
  'Participation in the GNW partnership and SGF/Fellowship alumni community.',
...
export const results = [
  ...
  {
    icon: Map,
    label: 'Over <b>1.8 billion hectares</b> of forests monitored using GNW',
  },
  {
    icon: People,
    label: 'Over <b>1,800</b> people trained in using GNW',
  },
];
