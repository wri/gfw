        ...
        <div className="privacy-container">
          <div id="intro">
            ...
            <p>
              ...
              USA (together with our affiliates and subsidiaries, “WRI”, “we”,
              “our” or “us”).
            </p>
            <p>
            ...
            <p>
              ...
              expect we&apos;ll do with your personal information when you make
              contact with us or use one of our services. In particular, this
              Privacy Policy explains how:
            </p>
            <ul>
              <li>
                we use your personal information when you visit our website,
                communicate with us, or provide us with your personal
          ...
          <div id="information-use">
            ...
            <ul>
              ...
              <li>
                handling, processing, and communicating with you about donations
                and other ways to contribute to WRI&apos;s mission;
              </li>
              <li>
                registering you for a WRI Service, including on a particular WRI
                website;
              </li>
              <li>
                providing you with updates, newsletters, data, other research,
                and/or donation-related communications you have requested;
              </li>
              ...
              <li>
                enabling TerraMatch users to map the boundaries of a tree
                planting project;
              </li>
              <li>
                allowing you to take part in Service features, and WRI
                campaigns, projects, events, or surveys;
              </li>
              <li>analyzing the use of our services or technologies; and</li>
              <li>
                considering you for employment if you have provided personal
                information pursuant to an application for a job with WRI.
              </li>
            </ul>
          </div>
          ...
          <div id="outreach-communications">
            ...
            <p>
              ...
              with communications about WRI, including, but not limited to email
              communications or information about WRI projects around the world
              and ways that you can contribute to our efforts.
            </p>
          ...
          <div id="information-disclosure">
            ...
            <ul>
              <li>
                to employees and independent contractors of WRI, analytic
                vendors, payment processing vendors, third party agents and
                other service providers and suppliers if the disclosure will
                enable that party to perform a business, professional, or
                technical support function for WRI or to perform a service that
                you have requested;
              </li>
              <li>to and between entities within the WRI group;</li>
              <li>
                where you give us permission to disclose your personal
                information to third parties selected by us in connection with
                our projects and campaigns;
              </li>
              <li>
                if we are required to do so to comply with a legal requirement
                or request from a competent court, regulator or other authority;
              </li>
              <li>
                where we deem it necessary, in our sole discretion, to protect
                our legal rights or property or the legal rights or property of
                an individual who registers with an WRI service or technology or
                any third party, or to prevent personal injury; and/or
              </li>
              <li>
                in connection with a sale, merger, assignment, reorganization,
                joint venture or other transfer or disposition of a portion or
                all of our assets or our affiliated entities (including, without
                limitation, in connection with any bankruptcy or similar
                proceedings).
              </li>
            </ul>
            <p>
          ...
          <div id="security-quality">
            ...
            <p>
              ...
              personal information you provide on secured computer servers that
              are located in controlled facilities. Additionally, when we
              transmit sensitive personal information over the internet, we
              protect it through the use of appropriate technological and
              administrative means.
            </p>
            <p>
              We do our best to maintain the accuracy of any personal
              information you supply to us. You can help WRI update and maintain
              the accuracy of any personal information you supply by notifying
              WRI of any changes to your address, title, phone number or e-mail
              address. In some parts of the WRI Services, you may do this online
              by following the instructions on membership profile pages. You may
              also do this by using the contact information provided below.
            </p>
            <p>
              Transmission of information on the internet is not completely
              secure, and we cannot guarantee the security of information sent
              on our Services. Transmission of such information is at your own
              risk.
            </p>
          </div>
          ...
          <div id="transfers">
            ...
            <p>
              ...
              personal information protection standards as the country you live
              in.
            </p>
          </div>
          ...
          <div id="external-links">
            ...
            <p>
              ...
              Policy, and we are not responsible for the privacy practices
              within any other website. You should be aware of this when you
              leave a WRI area, including our websites, and we encourage you to
          ...
          <div id="information-access-deletion">
            ...
            <p>
              ...
              that we delete the information we hold about you. Please address
              requests (with a return email address where possible) to:
            </p>
            WRI Communications
            <address>
              <a
          ...
          <div id="info-individuals-eea">
            ...
            <ul>
              <li>
                ...
                data from a TerraMatch user&apos;s device in order to map a
                planting project, we do so only with your consent. When you have
                made a past donation and have not objected to marketing
                communications, and we send you information about how you can
                continue to support WRI, we process your personal information
                based on legitimate interest. Where you give us your personal
                information for any other reason, we process your personal
                information for our legitimate business purposes to respond to
                your requests (for example, providing you with access to our
                websites or providing you with newsletter communications that
                you have requested);
              </li>
              <li>
                ...
                unhappy with how we process your personal information. In
                certain circumstances, you may also have the right to receive a
                copy of your personal information in a machine-readable format
                or to have your personal information sent to another company.
              </li>
            </ul>
          </div>
          ...
          <div id="donation-processing">
            ...
            <p>
              ...
              Payments, to process your online donations. Where you make a
              donation to WRI online, your personal information will be shared
              between WRI and iATS Payments as necessary to complete your
              donation, communicate with you about your donation, and as may be
              necessary to comply with our legal obligations. Information
          ...
          <div id="changes-oversight-questions">
            ...
            <p>
              ...
              reasonable effort to keep your information secure. Due to the
              rapidly evolving changes on the internet, we may update this
              Privacy Policy. All revisions will be posted to the relevant WRI
              website. Regularly viewing this Privacy Policy ensures that you
              are always aware of what information we collect, how we use it and
              under what circumstances we will share it with third parties. If
              you do not agree to the changes, please do not continue to use the
              particular WRI website or WRI service through which you have
