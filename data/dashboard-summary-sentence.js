...
export default {
  global: {
    summary: `Explore interactive charts and maps that summarize key statistics about global forests. Statistics and global rankings – including rates of forest change, forest extent and drivers of deforestation – can be customized, easily shared and downloaded for offline use. ${DOWNLOAD_GLOBAL_STATS}`,
    'land-cover':
    ...
    'forest-change': `Explore interactive charts and maps that summarize global rates of forest change. Statistics – including rankings of countries with the most forest loss and gain, and drivers of deforestation – can be customized, easily shared and downloaded for offline use. ${DOWNLOAD_GLOBAL_STATS}`,
    fires:
  ...
  country: {
    summary: `Explore interactive charts and maps that summarize key statistics about forests in {location}. Statistics – including rates of forest change, forest extent, drivers of deforestation, and deforestation and fire alerts – can be customized, easily shared and downloaded for offline use. ${DOWNLOAD_GLOBAL_STATS}`,
    'land-cover':
    ...
    'forest-change': `Explore interactive charts and maps that summarize rates of forest change in {location}. Statistics – including rankings of regions with the most forest loss and gain – can be customized, easily shared and downloaded for offline use. ${DOWNLOAD_GLOBAL_STATS}`,
    'land-use':
  ...
  adm1: {
    summary: `Explore interactive charts and maps that summarize key statistics about forests in {adm1}, {location}. Statistics – including rates of forest change and forest extent – can be customized, easily shared and downloaded for offline use. ${DOWNLOAD_GLOBAL_STATS}`,
    'land-cover':
    ...
    'forest-change': `Explore interactive charts and maps that summarize rates of forest change in {adm1}, {location}. Statistics – including rankings of regions with the most forest loss and gain – can be customized, easily shared and downloaded for offline use. ${DOWNLOAD_GLOBAL_STATS}`,
    fires:
  ...
  adm2: {
    summary: `Explore interactive charts and maps that summarize key statistics about forests in {adm2}, {adm1}, {location}. Statistics – including rates of forest change and forest extent – can be customized, easily shared and downloaded for offline use. ${DOWNLOAD_GLOBAL_STATS}`,
    'land-cover':
    ...
    'forest-change': `Explore interactive charts and maps that summarize rates of forest change in {adm2}, {adm1}, {location}. Forest cover change statistics – including rankings of regions with the most forest loss and gain – can be customized, easily shared and downloaded for offline use. ${DOWNLOAD_GLOBAL_STATS}`,
    fires:
