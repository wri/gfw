var AnalysisServiceResponse = {
  fires: {
    apis: {
      national:
        'http://localhost/nasa-active-fires/admin{/iso}{?period,download,bust,dev}',
      subnational:
        'http://localhost/nasa-active-fires/admin{/iso}{/id1}{?period,download,bust,dev}',
      use:
        'http://localhost/nasa-active-fires/use/{/name}{/id}{?period,download,bust,dev}',
      wdpa:
        'http://localhost/nasa-active-fires/wdpa/{/id}{?period,download,bust,dev}',
      world:
        'http://localhost/nasa-active-fires{?period,geojson,download,bust,dev}'
    },
    download_urls: {
