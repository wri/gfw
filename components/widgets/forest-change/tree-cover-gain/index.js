...
export default {
  ...
  sentences: {
    globalInitial:
      'From 2000 to 2012, {gain} of tree cover was gained {location}.',
    globalWithIndicator:
      'From 2000 to 2012, {gain} of tree cover was gained within {indicator} {location}.',
    initial:
      'From 2000 to 2012, {location} gained {gain} of tree cover equal to {gainPercent} of the global total.',
    withIndicator:
      'From 2000 to 2012, {location} gained {gain} of tree cover in {indicator} equal to {gainPercent} of the global total.',
    regionInitial:
      'From 2000 to 2012, {location} gained {gain} of tree cover {indicator} equal to {gainPercent} of all tree cover gain in {parent}.',
    regionWithIndicator:
      'From 2000 to 2012, {location} gained {gain} of tree cover in {indicator} equal to {gainPercent} of all tree cover gain in {parent}.',
  },
  settings: {
    threshold: 0,
    unit: 'ha',
