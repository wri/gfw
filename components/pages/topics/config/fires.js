// intro
import intro1x from 'components/pages/topics/assets/fires/intro/intro-fires.png';

// slides
import fires1 from 'components/pages/topics/assets/fires/slides/fires1.png';
import fires2 from 'components/pages/topics/assets/fires/slides/fires2.png';
import fires3 from 'components/pages/topics/assets/fires/slides/fires3.png';
import fires4 from 'components/pages/topics/assets/fires/slides/fires4.png';

// cards
import areas from 'components/pages/topics/assets/fires/cards/areas.png';
import widgetStats from 'components/pages/topics/assets/fires/cards/widget-stats.png';
import widgetCumulative from 'components/pages/topics/assets/fires/cards/widget-cumulative.png';
import mapLayer from 'components/pages/topics/assets/fires/cards/map-layer.png';
import forestFire from 'components/pages/topics/assets/fires/cards/forest-fire.png';
import forestWatcher from 'components/pages/topics/assets/fires/cards/forest-watcher.png';

// animations
import scene1 from 'components/pages/topics/assets/fires/animations/scene1.json';
import birds1 from 'components/pages/topics/assets/fires/animations/birds1.json';
import scene2 from 'components/pages/topics/assets/fires/animations/scene2.json';
import scene3 from 'components/pages/topics/assets/fires/animations/scene3.json';
import sunHeat3 from 'components/pages/topics/assets/fires/animations/heat_sun3.json';
import scene4 from 'components/pages/topics/assets/fires/animations/scene4.json';
