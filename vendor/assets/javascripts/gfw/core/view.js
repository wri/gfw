(function() {
  ...
  */
  var View = gfw.core.View = Backbone.View.extend({
    ...
    constructor: function(options) {
      ...
      gfw.core.Profiler.new_value('total_views', View.viewCount);
    },
    ...
    */
    ...
    getTemplate: function(tmpl) {
      ...
      return gfw.templates.getTemplate(tmpl);
    },
    ...
    */
    runChecker: function() {
      _.each(gfw.core.View.views, function(view) {
        _.each(view, function(prop, k) {
          if( k !== '_parent' &&
            view.hasOwnProperty(k) &&
            prop instanceof gfw.core.View &&
