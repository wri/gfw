(function () {
  ...
  document.write( '<div id="loading_tag_cloud">Loading tags...</div> <ul class="tag_list"></ul>');
  ...
  $(document).ready(function() {
    ...
    function getCloud() {
      ...
      for (tag in cloud) {
        ...
        link = '<a href="'+url_base+'tagged/'+tag+'" title="'+title+'">' + tag + '<span class="count">'+ tag_counts[tag_counts.length - 1] +'</span></a>';
        output = '<li>' + link + '</li>';
